...
class Comision(models.Model):
    ...
    casa_id = fields.Many2one('enjoy.casa', 'Nombre de la Casa', required=True)
...
class Casa(models.Model):
    ...
    lugar = fields.Many2one('enjoy.lugar', 'Localización', required=True)
    ...
    comision_ids = fields.One2many('enjoy.comision', 'casa_id', 'Comisiones', auto_join=True)
